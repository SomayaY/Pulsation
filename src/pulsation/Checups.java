...
public class Checups extends javax.swing.JFrame {
    ...
    public Checups(Patient newPatient) {
    ...
    private void initComponents() {
        ...
        setTitle("Checups Page");
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel6.setBackground(new java.awt.Color(255, 255, 255));
        jPanel6.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(0, 153, 153)));
        ...
        jButton4.setFont(new java.awt.Font("Yet R", 1, 24)); // NOI18N
        jButton4.setForeground(new java.awt.Color(0, 153, 153));
        jButton4.setText("Biopsies");
        jButton4.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(0, 153, 153)));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pulsation/Laboratory.jpg"))); // NOI18N

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pulsation/Radiology.jpg"))); // NOI18N

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pulsation/Analysis.jpg"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pulsation/biopsies.jpg"))); // NOI18N
        ...
        getContentPane().add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1070, 600));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Checups.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
